...
NODE_CLASS_MAPPINGS: dict[str, type] = {"UtilityNodesClothingPosition": ClothingPosition}
NODE_DISPLAY_NAME_MAPPINGS: dict[str, str] = {"UtilityNodesClothingPosition": "Position"}
